...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="h-full bg-secondary text-white alice-regular">
    ...
    <!-- Navbar -->
    <nav class="hidden xl:grid grid-cols-4 justify-items-center items-center select-none text-neutral-400 h-20 xl:px-64 w-full fixed z-40 top-0 bg-secondary backdrop-blur-3xl">
